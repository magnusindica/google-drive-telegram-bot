class config:
    BOT_TOKEN = "5028129253:AAG5qNZbwglnurqid4xWjstCrM5p2oK4dqQ"
    APP_ID = "18631963"
    API_HASH = "2419ec7ba2219f33a15dc1254a6bd6d4"
    DATABASE_URL = "postgres://agpurqxywtibra:e06155f917a77fcce6839453059c5b6b3b302f107d8c0e0702895753769b4be1@ec2-52-70-205-234.compute-1.amazonaws.com:5432/d9iufqdd8sesdm"
    SUDO_USERS = "1040519907" # Sepearted by space.
    SUPPORT_CHAT_LINK = ""
    DOWNLOAD_DIRECTORY = "./downloads/"
    G_DRIVE_CLIENT_ID = "1018210489842-gdaref1grs3bpsr2483qbm284jbsbs6t.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "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"
...
class Messages:
    START_MSG = "**Hi there {}.**\n__I'm  Rapid Google Drive Uploader Bot.You can use me to upload any file to Google Drive from either a direct link or Telegram File.Due to the api being unverified , you may receive a warning while attaching your drive(you could safely ignore that)__\n__You can know more from /help.__"

    HELP_MSG = [
        ".",
        "**Google Drive Uploader**\n__I can upload files from direct link or Telegram Files to your Google Drive. All you need to do is to authenticate Google Drive Account and send a direct download link or Telegram File.__\n\nI have more features... ! Wanna know about it ? Just walkthrough this tutorial and read the messages carefully.",
